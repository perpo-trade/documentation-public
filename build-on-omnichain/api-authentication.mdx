...
<Steps>
  <Step title="Perpo Account ID">
    Register your account and obtain your account ID. The registration steps are provided [here](/build-on-omnichain/user-flows/accounts). Add your account ID to the request header as `perpo-account-id`.
  </Step>
